-- Fix Report Card Attendance and Rankings
-- This migration updates the get_student_term_report_details RPC to:
-- 1. Add fallback logic for attendance from student_term_reports
-- 2. Add levelName to student object
-- 3. Add snake_case aliases for ranking fields for better compatibility
...
BEGIN
    ...
    SELECT jsonb_agg(jsonb_build_object(
        ...
        'grade', COALESCE(se.grade, se.grade_label),
