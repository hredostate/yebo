...
import type { TimetableEntry, Subject } from '../src/types.js';
...
function buildEntry(id: number, overrides: Partial<TimetableEntry> = {}): TimetableEntry {
  return {
    id,
    school_id: 1,
    term_id: 1,
...
const studentAccess = resolveTimetableAccess('student', { class_id: 42 } as any);
