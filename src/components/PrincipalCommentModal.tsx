...
interface PrincipalCommentModalProps {
    classId: number;
    className: string;
    termId: number;
    students: Student[];
...
const PrincipalCommentModal: React.FC<PrincipalCommentModalProps> = ({
    className,
    termId,
    students,
    studentTermReports,
    ...
    const [commentEdits, setCommentEdits] = useState<CommentEdit[]>(() => {
        ...
        return studentTermReports.map(report => {
            ...
            return {
                ...
                currentComment: report.principal_comment || '',
                editedComment: report.principal_comment || '',
...
export default PrincipalCommentModal;
