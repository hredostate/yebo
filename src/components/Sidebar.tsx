...
const NAV_STRUCTURE: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: VIEWS.COVERAGE_REPORTING, label: 'Coverage Reporting', permission: 'view-coverage-feedback' },
      ...
      { id: VIEWS.TEACHER_SCORE_ENTRY, label: 'Score Entry', permission: 'score_entries.edit_self' },
    ]
  },
  {
    id: 'students',
    ...
    items: [
      ...
      { id: VIEWS.STUDENT_CREDENTIALS_BULK_SEND, label: 'Send Credentials', permission: 'manage-students' },
      ...
      >
        <div className="h-full px-4 sm:px-4 py-6 bg-white dark:bg-slate-900 rounded-r-2xl md:rounded-l-none flex flex-col shadow-2xl overflow-hidden border-r border-slate-200 dark:border-slate-700">
          ...
          <div className="flex items-center justify-between mb-6 pl-1">
             <a href="#" onClick={() => onNavigate(VIEWS.DASHBOARD)} className="flex items-center gap-3 group touch-target focus-visible-ring">
