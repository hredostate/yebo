...
export const isStudentAllowedView = (view: string): boolean => {
  return (
...
export const getInitialTargetViewFromHash = (): string | null => {
  try {
...
export const getWeekStartDateString = (date: Date): string => {
...
export const useInitialTargetView = () => useRef<string | null>(getInitialTargetViewFromHash());
