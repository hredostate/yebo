...
Focus on assignments with low completion rates or coverage issues. Return an empty array if all assignments are on track.`;
    ...
    if (booting) {
        return <div className="flex items-center justify-center h-screen bg-white dark:bg-slate-900"><Spinner size="lg" /></div>;
    }
    ...
    if (!userProfile) {
        return <div className="flex items-center justify-center h-screen bg-white dark:bg-slate-900"><Spinner size="lg" text="Loading profile..." /></div>;
    }
